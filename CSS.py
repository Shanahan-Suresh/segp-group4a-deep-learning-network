...
QPushButtonCSS = "QPushButton {color: #000;border: 2px solid #555; border-radius: 20px;border-style: " \
                 "outset;background: qradialgradient(cx: 0.3, cy: -0.4, fx: 0.3, fy: -0.4,radius: 1.35, stop: 0 #fff, "\
                 "stop: 1 #888);padding: 1px;} ""QPushButton:hover {background: qradialgradient(cx: 0.3, cy: -0.4, " \
                 "fx: 0.3, fy: -0.4,radius: 1.35, stop: 0 #fff, stop: 1 #bbb);}""QPushButton:pressed {border-style: " \
                 "inset;background: qradialgradient(cx: 0.4, cy: -0.1, fx: 0.4, fy: -0.1,radius: 1.35, stop: 0 #fff, " \
                 "stop: 1 #ddd);} "

QLineEditCSS= "QLineEdit{background-color:white}"
...
EditIconCSS = "QPushButton {image: url(TestIcon.png);border :1px solid black;}"
...
MenuBarCSS = "QMenuBar{background-color: white}""QMenu{background-color: white}""QMenu::item:selected { " \
             "background-color: #1261A0;color: rgb(255,255," \
             "255);} "

TableCSS = "QTableWidget {background-color: rgb(255,255,255);}"

LoadIconCSS = "QPushButton{image: url(LoadIcon.png);border :1px solid black;}"
